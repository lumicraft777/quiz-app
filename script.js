...
const CATEGORY_ORDER = [
  "基礎知識", "太陽光発電", "システム設計・発電量計算", "機器・部品の知識", "施工・設置の知識", "系統連系と電力制度", "関係法規", "維持管理・O&M",
...
const GENRE_ORDER = ["1章 基礎知識", "2章 システム設計・発電量計算", "3章 機器・部品の知識", "4章 施工・設置の知識", "5章 系統連系と電力制度", "6章 関係法規", "7章 維持管理・O&M", "製品問題"];
